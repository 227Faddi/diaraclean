...
const CTA = () => {
  return (
    <section id="cta" className="py-32 px-2 sm:px-6">
      <div className="bg-gradient-to-br from-primary to-secondary text-white rounded-3xl p-6 lg:p-12 shadow-2xl max-w-5xl">
        <div className="mx-auto px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-10 text-gray-800">
            <Link
